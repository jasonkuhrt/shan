...
```
/shan transcript print                         # pick a session interactively
...
| Argument       | Description                                                                               |
| -------------- | ----------------------------------------------------------------------------------------- |
| `[session-id]` | Optional. Partial UUID prefix (e.g., `dc8ffe42`). Omit for interactive session selection. |
...
```
/shan transcript dump              # pick a session and dump it

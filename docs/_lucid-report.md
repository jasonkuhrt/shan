...
| Inspect transcripts | `content/docs/guides/inspect-transcripts.mdx` | src/bin/transcript/*.ts, src/lib/transcript-*.ts, design docs |
| Work with tasks | `content/docs/guides/work-with-tasks.mdx` | src/bin/task/*.ts, src/lib/task-*.ts |
